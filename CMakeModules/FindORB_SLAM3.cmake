...
# Find built-in DBoW2
find_path(G2O_INCLUDE_DIR g2o
          PATHS ${_ORB_SLAM3_SEARCHES} PATH_SUFFIXES Thirdparty/g2o )

          # Find built-in DBoW2
find_path(G2O_INCLUDE_DIR2 g2o
PATHS ${_ORB_SLAM3_SEARCHES} PATH_SUFFIXES Thirdparty/g2o/build )

# Find built-in g2o
find_library(g2o_LIBRARY NAMES g2o_core
             PATHS ${_ORB_SLAM3_SEARCHES} PATH_SUFFIXES lib Thirdparty/g2o/lib Thirdparty/g2o)

message("xxxxx11 ${G2O_INCLUDE_DIR2}")
...
find_library(Sophus_LIBRARY NAMES Sophus
             PATHS ${_ORB_SLAM3_SEARCHES} PATH_SUFFIXES lib Thirdparty/Sophus)
...
set(ORB_SLAM3_INCLUDE_DIRS ${ORB_SLAM3_INCLUDE_DIR} ${ORB_SLAM3_INCLUDE_DIR}/CameraModels ${DBoW2_INCLUDE_DIR} ${G2O_INCLUDE_DIR2} ${G2O_INCLUDE_DIR} ${Sophus_INCLUDE_DIR} )
